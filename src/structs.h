 ...
 */
#define _CIRCLEMUD	0x030012	/* Major/Minor/Patchlevel - MMmmPP */
...
/*
 * Da incrementare ogni volta che si rilascia qualche modifica
 * dei sorgenti, utile per capire se il server e' aggiornato
 *
 */
...
#define ROOM_ENTRANCE		(1 << 16)	/* (R) Modifyable/!compress  */
#define ROOM_ELEVATOR		(1 << 17)	/* (R) breath-first srch mrk */
...
#define CLASS_MARTIAL     4
#define CLASS_LINKER      5
#define CLASS_PSIONIC     6

#define NUM_CLASSES	  7			/* This must be the number of classes FOR PC!! */

/* NPC classes (currently unused - feel free to implement!) */
//#define CLASS_OTHER       0
/* NPC CLASSES, */
#define CLASS_UNDEAD      7
#define CLASS_HUMANOID    8
#define CLASS_ANIMAL      9
#define CLASS_DRAGON      10
#define CLASS_GIANT       11

#define NUM_NPC_CLASSES   12   /* This is the number of NPC classes */

#define RACE_UNDEFINED   -1
#define RACE_UMANO        0
#define RACE_CYBORG       1
#define RACE_MOTOCICLISTA 2
#define RACE_ALIENO       3
...
#define AFF_REGEN_HP	      (1 << 20)	/* Regenerating HP */
#define AFF_CHARM             (1 << 21)	/* Char is charmed       */
#define AFF_FLY               (1 << 22)	/* Char is flying        */
#define AFF_REGEN_MANA        (1 << 23) /* Regenerating Mana*/
...
/* missile object type */
#define MISSILE_OBJ         0	/* unused */
#define MISSILE_9_MM        1	/* Pallottole 9 mm */
#define MISSILE_ARROW       2	/* frecce */
#define MISSILE_XBOW        3	/* dardi */
#define MISSILE_SHELL       4	/* shotgun */
#define MISSILE_ROCKET      5	/* razzi */
#define MISSILE_GRENADE     6	/* granate 40 mm */
#define MISSILE_762_NATO    7	/* pallottola 7.62 mm NATO */
#define MISSILE_556_NATO    8	/* pallottole 5.56 mm NATO */
#define MISSILE_762_AK      9	/* pallottole 7.62 mm AK */
#define MISSILE_542_AK      10	/* pallottole 5.42 mm AKM */
#define MISSILE_9_PARAB     11	/* pallottole 9 mm Parabellum */
...
#define ITEM_THROW     24		/* item is throwable */
#define ITEM_GRENADE   25		/* Item is a grenade */
#define ITEM_PORTAL    26		/* Item is a portal */
...
#define ITEM_WEAR_SHOULDER  (1 << 16)	/* Can be worn on shoulder */
#define ITEM_WEAR_EAR       (1 << 17)	/* Can be worn on ear */
#define ITEM_WEAR_EYE       (1 << 18)	/* Can be worn on eyes */
...
#define ITEM_LIVE_GRENADE  (1 << 17)	/* r grenade's pin has been pulled */
#define ITEM_ANTI_UMANO    (1 << 18)	/* s Not usable by Humans   */
#define ITEM_ANTI_CYBORG  (1 << 19)	/* t Not usable by Elves    */
#define ITEM_ANTI_MOTOCICLISTA    (1 << 20)	/* u Not usable by Gnomes   */
#define ITEM_ANTI_ALIENO    (1 << 21)	/* v Not usable by Fairies  */
#define ITEM_ANTI_MARTIAL   (1 << 22)	/* w Not for PACIF          */
#define ITEM_ANTI_LINKER   (1 << 23)	/* x Not for LINKER         */
#define ITEM_ANTI_PSIONICO   (1 << 24)	/* y Not for PSIONIC        */
#define ITEM_AUTOMATIC_FIREWEAPON (1 << 25)	/*z  E' una arma automatica */
...
/* trap flags */
#define TRAP_EFF_MOVE      (1 << 0)	/* trigger on movement    */
#define TRAP_EFF_OBJECT    (1 << 1)	/* trigger on get or put  */
#define TRAP_EFF_ROOM      (1 << 2)	/* affect all in froom    */
#define TRAP_EFF_NORTH     (1 << 3)	/*  movement in this dir  */
#define TRAP_EFF_EAST      (1 << 4)
#define TRAP_EFF_SOUTH     (1 << 5)
#define TRAP_EFF_WEST      (1 << 6)
#define TRAP_EFF_UP        (1 << 7)
#define TRAP_EFF_DOWN      (1 << 8)
...
#define LIQ_BIRRA      17
#define LIQ_VINO       18
#define LIQ_LIMONATA   19
#define LIQ_THE        20
#define LIQ_CAFFE      21
#define LIQ_APERITIVO  22
...
#define SUN_DARK	        0
#define MOON_QUARTER_SMALL  1
#define MOON_QUARTER_LARGE  2
#define MOON_FULL_SMALL     3
#define MOON_FULL_LARGE     3
#define SUN_RISE	        4
#define SUN_SET		        5
#define SUN_LIGHT	        6

/* moon phase */
#define MOON_DARK           0	/* luna nuova */
#define MOON_CRESCENT_RISE  1
#define MOON_RISE           2	/* primo quarto */
#define MOON_PARTIAL_RISE   3
#define MOON_FULL           4	/* luna piena */
#define MOON_PARTIAL_FALL   5
#define MOON_FALL           6	/* ultimo quarto */
#define MOON_CRESCENT_FALL  7
 ...
 */
#define LVL_IMPL	64
#define LVL_GRGOD	(LVL_IMPL-1)
#define LVL_GOD		(LVL_GRGOD-1)
#define LVL_IMMORT	(LVL_GOD-1)
...
// 25.9.2001 Obsoleto con l'adozione dell'Ascii playerfiles.
// PEr il momento e' meglio non rimuovere perche sono usati dai vari utils
//
struct char_file_u
{
	/* char_player_data */
...
struct astral_body
{
	int abs_pos;				/* posizione assoluta   */
	int rel_pos;				/* posizione relativa   */
	int phase;					/* fase della luna      */
};
...
struct weather_data
{
	...
	struct astral_body sun;
	struct astral_body moon1;
	struct astral_body moon2;
};

/* Nuova struttura per la tabella di livelli e titoli dei player 
*/
struct title_type
{
	char *title_m;
