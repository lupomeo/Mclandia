...
#define TRADE_NOMARTIAL		(1 << 7)
#define TRADE_NOLINKER		(1 << 8)
#define TRADE_NOPSIONICO	(1 << 9)
...
#define NOTRADE_MARTIAL(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOMARTIAL))
#define NOTRADE_LINKER(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOLINKER))
#define NOTRADE_PSIONICO(i)	(IS_SET(SHOP_TRADE_WITH((i)), TRADE_NOPSIONICO))
