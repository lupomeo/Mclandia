...
int
fbgetline (FBFILE * fbfl, char *line)
{
...
FBFILE *
fbopen_for_write (char *fname, int mode)
{
	FBFILE *fbfl;
...
int
fbprintf (FBFILE * fbfl, const char *format, ...)
{
...
int
fbcat (char *fromfilename, FBFILE * tofile)
{
	struct stat sb;
	FILE *fromfile;
	char *in_buf = 0;
