...
ACMD (do_write);
ACMD (do_zreset);
ACMD (do_build_version);

/* New Ranged weapons command */
ACMD (do_load_weapon);
ACMD (do_fire);
ACMD (do_throw);
ACMD (do_pull);
...
cpp_extern const struct command_info cmd_info[] = {
	...
	{"autofire", POS_RESTING, do_autofire, 0, 0},
	...
	{"bhug", POS_RESTING, do_action, 0, 0},
	...
	{"connect", POS_RESTING, do_use, 0, SCMD_RECITE},
	...
	{"doorway", POS_STANDING, do_doorway, 1, 0},
	...
	{"firstaid", POS_RESTING, do_first_aid, 1, 0},
	{"five", POS_RESTING, do_action, 0, 0},
	...
	{"hgroan", POS_RESTING, do_action, 0, 0},
	...
	{"messenger", POS_SLEEPING, do_send, 0, 0},
	...
	{"pray", POS_SITTING, do_pray, 0, 0},
    {"ps", POS_DEAD, do_ps_aux, 0, 0},
    {"psi", POS_SITTING, do_psi, 1, 0},
    {"psychic", POS_DEAD, do_psychic, 0, 0},
	...
	{"quivering", POS_FIGHTING, do_quivering_palm, 1, 0},
	...
	{"reload", POS_RESTING, do_load_weapon, 0, 0},
	...
	{"snoop", POS_DEAD, do_snoop, LVL_IMPL, 0},
	...
	{"springleap", POS_RESTING, do_springleap, 1, 0},
    ...
    {"gwho", POS_DEAD, do_group_who, 0, 0},
	...
	{"wizreload", POS_DEAD, do_reboot, LVL_IMPL, 0},
    {"wizbuild", POS_DEAD, do_build_version, LVL_IMPL, 0},
...
//  struct char_file_u tmp_store;
	...
	case CON_GET_NAME:			/* wait for input of name */
		if (d->character == NULL)
		{
			...
			CREATE (d->character->player_specials, struct player_special_data,
					1);
			d->character->desc = d;
		}
		if (!*arg)
		...
		else
		{
			...
			{
				SEND_TO_Q ("Nome sconosciuto, provane un altro.\r\n"
						   "Name: ", d);
				return;
			}
			...
			if ((player_i = load_char (tmp_name, d->character)) > -1)
			{
				...
				if (PLR_FLAGGED (d->character, PLR_DELETED))
				{
					...
					{
						SEND_TO_Q
							("Nome sconosciuto, provane un altro.\r\nName: ",
							 d);
						return;
					}
					CREATE (d->character, struct char_data, 1);
					...
					GET_PFILEPOS (d->character) = player_i;
					sprintf (buf, "E' giusto, %s (Y/N)? ", tmp_name);
					SEND_TO_Q (buf, d);
			...
			else
			{
				...
				if (!Valid_Name (tmp_name))
				{
					SEND_TO_Q ("Nome non valido, provane un altro.\r\nName: ",
							   d);
					return;
				}
				CREATE (d->character->player.name, char,
	...
	case CON_NAME_CNFRM:		/* wait for conf. of new name    */
		if (UPPER (*arg) == 'Y')
		{
			...
			sprintf (buf, "Inserisci la password per %s: ",
		...
		{
			SEND_TO_Q ("Va bene, allora qual'e'? ", d);
		...
		{
			SEND_TO_Q ("Per piacere digita Yes o No: ", d);
		}
		break;
		...
		else
		{
				 ...
				 GET_PASSWD (d->character), MAX_PWD_LENGTH))
			{
				...
				{				/* 3 strikes and you're out. */
					SEND_TO_Q ("Pasword errata... disconnessione.\r\n", d);
					STATE (d) = CON_CLOSE;
				}
				else
				{
	...
	case CON_QSEX:				/* query sex of new user         */
		...
		case 'F':
			...
			break;
		default:
			SEND_TO_Q ("Questo non e' un sesso..\r\n"
					   "Qual'e' il tuo sesso? ", d);
			return;
		}
	...
	case CON_QRACE:
		...
		sprintf (buf, "%s [%s] Nuovo Giocatore", GET_NAME (d->character),
				 d->host);
	...
	case CON_MENU:				/* get selection from main menu  */
		...
		case '1':
			...
			act ("$n e' entrato nel gioco.", TRUE, d->character, 0, 0,
				 TO_ROOM);
		...
		case '2':
			...
			SEND_TO_Q ("Inserisci la descrizione del tuo personaggio.\r\n",
					   d);
			SEND_TO_Q ("Terminala con un '@' su una nuova linea.\r\n", d);
		...
		case '4':
			SEND_TO_Q ("\r\nImmetti la vecchia password: ", d);
			echo_off (d);
			STATE (d) = CON_CHPWD_GETOLD;
			break;

		case '5':
			SEND_TO_Q ("\r\nImmetti la password per la verifica: ", d);
			echo_off (d);
			STATE (d) = CON_DELCNF1;
			break;

		default:
			SEND_TO_Q ("\r\nQuesta non e' una scelta del menu!\r\n", d);
			SEND_TO_Q (MENU, d);
			break;
		}
