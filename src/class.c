 ...
 */
#define USE_NEW_XP_TABLE 1

#ifdef USE_NEW_XP_TABLE 
/*Nuovo sistema il EXP_MAX diventera 400000000  */
...
level_exp (int chclass, int level)
{
    ...
    return titles[chclass][level].exp;
...
title_male (int chclass, int level)
{
    ...
    return titles[chclass][level].title_m;
	...
	case CLASS_CLERIC:
		...
		{
		case 1:
			return "the newbie sysadmin [1]";
		case 2:
			return "the newbie sysadmin [2]";
		case 3:
			return "the newbie sysadmin [3]";
		case 4:
			return "the newbie sysadmin [4]";
		case 5:
			return "the newbie sysadmin [5]";
		case 6:
			return "the newbie sysadmin [6]";
		case 7:
			return "the newbie sysadmin [7]";
		case 8:
			return "the newbie sysadmin [8]";
		case 9:
			return "the newbie sysadmin [9]";
		case 10:
			return "the newbie sysadmin [10]";
		case 11:
			return "the chump sysadmin [1]";
		case 12:
			return "the chump sysadmin [2]";
		case 13:
			return "the chump sysadmin [3]";
		case 14:
			return "the chump sysadmin [4]";
		case 15:
			return "the chump sysadmin [5]";
		case 16:
			return "the chump sysadmin [6]";
		case 17:
			return "the chump sysadmin [7]";
		case 18:
			return "the chump sysadmin [8]";
		case 19:
			return "the chump sysadmin [9]";
		case 20:
			return "the chump sysadmin [10]";
		case 21:
			return "the medium sysadmin [1]";
		case 22:
			return "the medium sysadmin [2]";
		case 23:
			return "the medium sysadmin [3]";
		case 24:
			return "the medium sysadmin [4]";
		case 25:
			return "the medium sysadmin [5]";
		case 26:
			return "the medium sysadmin [6]";
		case 27:
			return "the medium sysadmin [7]";
		case 28:
			return "the medium sysadmin [8]";
		case 29:
			return "the medium sysadmin [9]";
		case 30:
			return "the medium sysadmin [10]";
		case 31:
			return "the expert sysadmin [1]";
		case 32:
			return "the expert sysadmin [2]";
		case 33:
			return "the expert sysadmin [3]";
		case 34:
			return "the expert sysadmin [4]";
		case 35:
			return "the expert sysadmin [5]";
		case 36:
			return "the expert sysadmin [6]";
		case 37:
			return "the expert sysadmin [7]";
		case 38:
			return "the expert sysadmin [8]";
		case 39:
			return "the expert sysadmin [9]";
		case 40:
			return "the expert sysadmin [10]";
		case 41:
			return "the adept sysadmin [1]";
		case 42:
			return "the adept sysadmin [2]";
		case 43:
			return "the adept sysadmin [3]";
		case 44:
			return "the adept sysadmin [4]";
		case 45:
			return "the adept sysadmin [5]";
		case 46:
			return "the adept sysadmin [6]";
		case 47:
			return "the adept sysadmin [7]";
		case 48:
			return "the adept sysadmin [8]";
		case 49:
			return "the adept sysadmin [9]";
		case 50:
			return "the adept sysadmin [10]";
		case 51:
			return "the guru sysadmin [1]";
		case 52:
			return "the guru sysadmin [2]";
		case 53:
			return "the guru sysadmin [3]";
		case 54:
			return "the guru sysadmin [4]";
		case 55:
			return "the guru sysadmin [5]";
		case 56:
			return "the guru sysadmin [6]";
		case 57:
			return "the guru sysadmin [7]";
		case 58:
			return "the guru sysadmin [8]";
		case 59:
			return "the guru sysadmin [9]";
		case 60:
			return "the guru sysadmin [10]";
			/* no one ever thought up these titles 21-30 */
		case LVL_IMMORT:
			return "the Immortal sysadmin";
		case LVL_GOD:
			return "the Gos sysadmin";
		case LVL_GRGOD:
...
title_female (int chclass, int level)
{
    ...
    return titles[chclass][level].title_f;
