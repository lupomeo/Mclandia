...
//IL TRENO
	...
	ferrys[0].arrive_messg_from =
		"Il treno e' arrivato alla Stazione di Mclandia ed i portelli sono aperti. Arrivederci al prossimo viaggio.\r\n";

	ferrys[0].arrive_dock_from =
		"Il treno diretto a NewLand arriva sferragliando sul primo binario. I signori passeggeri sono pregati di salire in carrozza.\r\n";
	...
	ferrys[0].leave_messg_from =
		"I portelli vengono chiusi e senti il treno per NewLand partire dolcemente e poi prendere velocita'.\r\n";
...
// IL BATTELLO
	...
	ferrys[1].arrive_dock_from =
		"Il battello fluviale arriva lentamente, attracca e tira giu' la passerella per accogliere i nuovi passeggeri\r\n";

	ferrys[1].arrive_messg_to =
		"Vedi apparire il poticciolo di NewLand. Il battello attracca e tira giu' la passerella per permettere ai passeggeri di scendere.\r\n";
